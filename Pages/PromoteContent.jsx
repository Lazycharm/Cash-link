...
export default function PromoteContent() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            // Map type to valid entity_type values
            const entityTypeMap = {
                'business': 'business',
                'agent': 'business', // Agents are treated as business profiles
                'driver': 'business'  // Drivers are treated as business profiles
            };
            
            await PromotionRequest.create({
                user_id: user.id,
                entity_type: entityTypeMap[type] || 'business',
