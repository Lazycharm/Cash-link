    ...
    try {
      ...
      if (request) {
        await Notification.create({
          ...
          message: `Your ${request.package_name || 'promotion'} request for ${request.entity_type} has been marked as ${status}.`,
          type: "info"
        });
      }
              ...
              <div className="overflow-x-auto"> 
                <Table>
                  ...
                  <TableBody>
                    {requests.map((req) => (
                      <TableRow key={req.id}>
                        <TableCell className="font-medium">{req.package_name || 'N/A'}</TableCell>
                        ...
                        <TableCell>AED {req.cost || 0}</TableCell>
                        <TableCell>{req.duration_days || 7} days</TableCell>
                        <TableCell>
