    ...
    <div className="min-h-screen bg-[#F8F9FA] pb-24 md:pb-0 md:pl-[280px]">
      ...
      <header className="md:hidden fixed top-0 left-0 right-0 h-16 bg-white/90 backdrop-blur-md z-40 px-4 flex items-center justify-between shadow-sm border-b border-gray-100/50">
        <Link to="/" className="flex items-center gap-2">
          <img src="/logo.png" alt="CashLink" className="w-8 h-8 object-contain" />
                ...
                return (
                  <div key={item.id} className="relative -top-6">
                    <Link to={item.path}>
                      <motion.div
                        whileTap={{ scale: 0.9 }}
                        className="w-16 h-16 rounded-full bg-[#0A8F54] flex items-center justify-center text-white shadow-lg border-4 border-[#F8F9FA]"
